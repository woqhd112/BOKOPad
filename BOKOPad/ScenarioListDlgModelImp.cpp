...
{
	bool bSuccess = false;
	bSuccess = DB_INSTANCE->PrepareStatement_Execute(DefinedDMLQuerys[SELECT_ALL_SCENARIO_LIST_TABLE], NULL, ResultSetSelectAllScenarioList, NULL);
...
bool ScenarioListDlgModelImp::UpdateScenarioList(ComplexString in_title, int in_cnt, int update_seq)
{
	...
	bSuccess = DB_INSTANCE->PrepareStatement_Execute(DefinedDMLQuerys[UPDATE_SCENARIO_LIST_TABLE], NULL, PrepareStatementUpdateScenarioList, NULL);
...
bool ScenarioListDlgModelImp::DeleteScenarioList(int delete_seq)
{
	...
	bSuccess = DB_INSTANCE->PrepareStatement_Execute(DefinedDMLQuerys[DELETE_SCENARIO_LIST_TABLE], NULL, PrepareStatementDeleteScenarioList, NULL);
...
bool ScenarioListDlgModelImp::UpdateScenarioListInSceTITLE(ComplexString in_sceTITLE, int in_sceSEQ)
{
	...
	bSuccess = DB_INSTANCE->PrepareStatement_Execute(DefinedDMLQuerys[UPDATE_SCENARIO_LIST_TABLE_IN_SCETITLE], NULL, PrepareStatementUpdateScenarioListInSceTITLE, NULL);
...
bool ScenarioListDlgModelImp::UpdateScenarioListInNotCNT(int in_notCNT, int in_sceSEQ)
{
	...
	bSuccess = DB_INSTANCE->PrepareStatement_Execute(DefinedDMLQuerys[UPDATE_SCENARIO_LIST_TABLE_IN_NOTCNT], NULL, PrepareStatementUpdateScenarioListInNotCNT, NULL);
