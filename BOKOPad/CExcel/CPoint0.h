...
{
public:
	CPoint0(){} // COleDispatchDriver 기본 생성자를 호출합니다.
...
public:
	...
	{
		BOOL result;
		InvokeHelper(0xc83, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, NULL);
		return result;
	}
	void put_IsTotal(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0xc83, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
