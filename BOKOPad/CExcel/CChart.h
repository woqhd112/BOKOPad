...
{
public:
	CChart(){} // COleDispatchDriver 기본 생성자를 호출합니다.
...
public:
	...
	{
		BOOL result;
		InvokeHelper(0xc5e, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, NULL);
		return result;
	}
	void put_ShowExpandCollapseEntireFieldButtons(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0xc5e, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
	...
	{
		BOOL result;
		InvokeHelper(0xcff, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, NULL);
		return result;
	}
	void put_DisplayValueNotAvailableAsBlank(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0xcff, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
