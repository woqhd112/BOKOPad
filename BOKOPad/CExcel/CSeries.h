...
{
public:
	CSeries(){} // COleDispatchDriver 기본 생성자를 호출합니다.
...
public:
	...
	long get_ParentDataLabelOption()
	{
		long result;
		InvokeHelper(0xc84, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
		return result;
	}
	void put_ParentDataLabelOption(long newValue)
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0xc84, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
	BOOL get_QuartileCalculationInclusiveMedian()
	{
		BOOL result;
		InvokeHelper(0xc85, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, NULL);
		return result;
	}
	void put_QuartileCalculationInclusiveMedian(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0xc85, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
	long get_ValueSortOrder()
	{
		long result;
		InvokeHelper(0xc9d, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
		return result;
	}
	void put_ValueSortOrder(long newValue)
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0xc9d, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
	long get_GeoProjectionType()
	{
		long result;
		InvokeHelper(0xcb2, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
		return result;
	}
	void put_GeoProjectionType(long newValue)
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0xcb2, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
	long get_GeoMappingLevel()
	{
		long result;
		InvokeHelper(0xcb3, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
		return result;
	}
	void put_GeoMappingLevel(long newValue)
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0xcb3, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
	long get_RegionLabelOption()
	{
		long result;
		InvokeHelper(0xcb4, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
		return result;
	}
	void put_RegionLabelOption(long newValue)
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0xcb4, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
	long get_SeriesColorGradientStyle()
	{
		long result;
		InvokeHelper(0xcbd, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
		return result;
	}
	void put_SeriesColorGradientStyle(long newValue)
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0xcbd, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
	LPDISPATCH get_SeriesColorMinGradientStop()
	{
		LPDISPATCH result;
		InvokeHelper(0xcbe, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
		return result;
	}
	LPDISPATCH get_SeriesColorMidGradientStop()
	{
		LPDISPATCH result;
		InvokeHelper(0xcbf, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
		return result;
	}
	LPDISPATCH get_SeriesColorMaxGradientStop()
	{
		LPDISPATCH result;
		InvokeHelper(0xcc0, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
		return result;
	}
