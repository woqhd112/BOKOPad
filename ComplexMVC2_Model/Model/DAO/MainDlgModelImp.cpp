...
{
	bool bSuccess = false;
	bSuccess = DB_INSTANCE->PrepareStatement_Execute(DefinedDMLQuerys[SELECT_ALL_PAD_OPTION_TABLE], NULL, ResultSetSelectAllPadOption);
...
bool MainDlgModelImp::UpdateScenarioListAutoIncrementSeq()
{
	bool bSuccess = false;
	bSuccess = DB_INSTANCE->PrepareStatement_Execute(DefinedDMLQuerys[UPDATE_AUTOINCREMENT_RESET_SCENARIO_LIST], NULL);
